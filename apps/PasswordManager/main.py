...
def translate_init() -> None:
    ...
    for supported_language in supported_languages:
        try:
            with open(relative_file('src/apps/PasswordManager/' + supported_language + '.txt'), 'r') as language_file:
                _language = []
...
def get_names(password: str) -> list:
    try:
        with open(relative_file('src/apps/PasswordManager/' + 'passwords.bin'), 'rb') as encrypted_password_file:
...
def setup() -> str:
    with open(relative_file('src/apps/PasswordManager/' + 'config.txt'), 'w') as config_file:
        setup_window = tk.Tk()
    ...
    with open(relative_file('src/apps/PasswordManager/' + 'passwords.bin'), 'wb') as passwords_file:
...
def change_information(new_information: list) -> None:
    global _password
    with open(relative_file('src/apps/PasswordManager/' + 'passwords.bin'), 'wb') as password_file:
